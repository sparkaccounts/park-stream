...
ENTRYPOINT []
CMD ffmpeg -re -f concat -i mylist.txt -f lavfi -i smptebars=size=640x320:rate=15 -f flv -vcodec libx264 -pix_fmt yuv420p -preset fast -r 15 -g 30 rtmp://live-fra.twitch.tv/app/$TWITCH_STREAMKEY
